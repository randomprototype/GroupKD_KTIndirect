...
def main():
    ...
    if choice == menu[0]:
        ...
        for i, col in enumerate(columns):
            ...
            Eta1s.append(col.number_input(f"Scale parameter of the defect arrival distribution for the weak component", min_value=0.0, value=3.0, key=f"C^I_{i}", help="This parameter represents the characteristic life of the defect arrival for weak component i."))
