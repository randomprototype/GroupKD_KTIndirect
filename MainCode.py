...
def main():
    ...
    if choice == menu[0]:
        ...
        for i, col in enumerate(columns):
            ...
            Cis.append(col.number_input("Inspection Cost (C<sup>I</sup>)", min_value=0.0, value=0.05, key=f"C^I_{i}", help="This parameter represents the cost of conducting an inspection on component i.",format="%.2f"  # Formata como número com 2 casas decimais))
