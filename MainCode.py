...
def main():
    ...
    if choice == menu[1]:
        ...
        st.write("<h6 style='text-align: justify; color: Blue Jay; padding-left: 20px;'>Defect Arrival Distributions: Each component has a defect arrival distribution that reflects a mixture of "weak" and "strong" parts.</h6>", unsafe_allow_html=True)
